...
const USER_SERVICE_UUID = "53358e0c-ab8b-436e-93f7-76afeec2ea3a"; // LED, Button
...
const residentialId = "5e2ff439dc26604500e0be8e";
...
function uiToggleDeviceConnected(connected) {
  ...
  if (connected) {
    ...
    request.open(
      "GET",
      "https://9eaac27e.ngrok.io/Reservation/getReservation/" + lineId,
      true
    );
    request.onload = function() {
      ...
      if (request.status >= 200 && request.status < 400) {
        if (data.length > 0 && data[0].residentialId == residentialId && data[0].status == 1) {
